...
export const STICKERS: StickerDef[] = [
  ...
  { id: "mp3-player", Art: Mp3Player, size: 122, home: { x: 58, y: 64 }, rotation: -6, layer: 12, drift: { amplitude: 5, duration: 9, delay: 4.6 } },
  ...
  { id: "platform-boot", Art: PlatformBoot, size: 90, home: { x: 68, y: 44 }, rotation: -9, layer: 5, drift: { amplitude: 4, duration: 13, delay: 3.3 } },
  ...
  { id: "cassette-tape", Art: CassetteTape, size: 84, home: { x: 78, y: 58 }, rotation: -11, layer: 6, drift: { amplitude: 4, duration: 10, delay: 8.4 } },
